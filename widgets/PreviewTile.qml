...
Item {
	...
	Item {
		...
		Repeater {
			...
			delegate: Item {
				...
				property var toplevel: (root.toplevelForAddress && typeof root.toplevelForAddress === "function")
					? root.toplevelForAddress(windowData?.address)
					: null
	...
	Rectangle {
		...
		border.color: root.selected
			...
			: (root.hovered ? root.hoveredBorderColor : root.normalBorderColor)
		z: 2
	}
}
